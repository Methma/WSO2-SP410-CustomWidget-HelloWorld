...
var _WidgetChannelManager = require('./WidgetChannelManager');

var _WidgetChannelManager2 = _interopRequireDefault(_WidgetChannelManager);
...
var Widget = function (_Component) {
    ...
    _createClass(Widget, [{
        ...
        key: 'subscribe',
        value: function subscribe(listenerCallback, publisherId, context) {
            var _this2 = this;

            if (!publisherId) {
                var publisherIds = this.props.configs.pubsub.publishers;
                if (publisherIds && Array.isArray(publisherIds)) {
                    publisherIds.forEach(function (id) {
                        return _this2.props.glEventHub.on(id, listenerCallback);
                    });
                }
            } else {
        ...
        key: 'getWidgetChannelManager',
        value: function getWidgetChannelManager() {
            return _WidgetChannelManager2.default;
        }
    }], [{
        key: '_getStateObject',
