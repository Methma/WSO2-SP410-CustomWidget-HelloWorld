...
var BarChart = function (_BaseChart) {
    ...
    _createClass(BarChart, [{
         ...
         */
        value: function getBarChartComponent(chartArray, dataSets, config, onClick, xScale, ignoreArray, currentTheme) {
            var _this2 = this;
        ...
        value: function render() {
            ...
            var _getBarChartComponent = this.getBarChartComponent(chartArray, dataSets, config, this.handleMouseEvent, xScale, ignoreArray, currentTheme),
